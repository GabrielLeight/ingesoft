...
```
cd existing_repo
git remote add origin https://gitlab.inf.utfsm.cl/grupo-11/proyecto-analisis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.inf.utfsm.cl/grupo-11/proyecto-analisis/-/settings/integrations)
